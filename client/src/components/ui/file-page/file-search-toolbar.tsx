interface FileSearchToolbarProps {
    searchInput: string;
...
const FileSearchToolbar = ({ searchInput, onSearchInputChange, onSearch, onReload }: FileSearchToolbarProps) => {
    return (
...
export default FileSearchToolbar;
